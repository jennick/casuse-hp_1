...
const texts: Record<Lang, { title: string; intro: string }> = {
  en: {
    title: "Feasibility",
    intro: "Future view for technical and commercial feasibility checks.",
  },
  es: {
    title: "Viabilidad",
    intro: "Vista futura para chequeos de viabilidad técnica y comercial.",
  },
};

const FeasibilityPage: React.FC<Props> = ({ lang }) => {
  const t = texts[lang];
