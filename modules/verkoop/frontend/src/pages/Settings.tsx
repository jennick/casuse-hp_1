...
const texts: Record<Lang, { title: string; intro: string }> = {
  en: {
    title: "Settings",
    intro: "Module configuration and number series settings.",
  },
  es: {
    title: "Ajustes",
    intro: "Configuración del módulo y ajustes de series numéricas.",
  },
};

const SettingsPage: React.FC<Props> = ({ lang }) => {
  const t = texts[lang];
